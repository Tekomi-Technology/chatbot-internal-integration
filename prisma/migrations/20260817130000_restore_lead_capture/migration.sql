-- Dựng lại tính năng thu thập lead đã bị gỡ ở 20260814130000_remove_lead_capture.
-- Bảng cũ đã DROP nên dữ liệu lead trước 14/08 không lấy lại được.
...
ALTER TABLE "widget_configs"
  ...
  ADD COLUMN "lead_form_name_label" TEXT NOT NULL DEFAULT 'Họ và tên',
